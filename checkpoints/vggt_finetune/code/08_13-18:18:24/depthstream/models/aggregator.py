...
from depthstream.layers import PatchEmbed
from depthstream.layers.block import Block
from depthstream.layers.rope import RotaryPositionEmbedding2D, PositionGetter
from depthstream.layers.vision_transformer import vit_small, vit_base, vit_large, vit_giant2
...
class Aggregator(nn.Module):
    ...
    def forward(
        ...
        patch_tokens = self.patch_embed(images, dino_cond=dino_cond)
